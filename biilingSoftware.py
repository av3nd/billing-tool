...
# Title of the app
# --------------------------------------------------------------------------------
title = Label(root, pady=2, text="Billing Tool", bd=12, bg=frame_colour, fg='white', font=('cambria', 30, 'bold'))
title.pack(fill=X)
...
cname_label = Label(F1, text='Customer Name : ', font=('cambria', 18, 'bold'), bg=frame_colour, fg='white')
...
cphone_lbl=Label(F1,text='Phone Number : ',font=('cambria',18,'bold'),bg=frame_colour,fg='white')
...
itm = Label(F2, text='Product Name : ', font=('cambria',18, 'bold'), bg=frame_colour, fg='yellow').grid(row=0, column=0, padx=30, pady=20)
itm_txt = Entry(F2, width=20,textvariable=item, font='cambria 15 bold').grid(row=0, column=1, padx=10,pady=20)

rateofProduct = Label(F2, text='Product Rate : ', font=('cambria',18, 'bold'), bg=frame_colour, fg='yellow').grid(row=1, column=0, padx=30, pady=20)

rate_txt = Entry(F2, width=20,textvariable=rate, font='cambria 15 bold').grid(row=1, column=1, padx=10,pady=20)

quantityOfProduct = Label(F2, text='Product Quantity : ', font=('cambria',18, 'bold'), bg=frame_colour, fg='yellow').grid(row=2, column=0, padx=30, pady=20)
...
# ---------------------------------------------------------------------------------------------------------------
btn1=Button(F2,text='Add',font='cambria 15 bold',command=additm,padx=5,pady=10,bg='#3B7265',fg='white',width=15)
btn1.grid(row=3,column=0,padx=10,pady=30)
btn2=Button(F2,text='Get Bill',font='cambria 15 bold',command=gbill,padx=5,pady=10,bg='#3B7265',fg='white',width=15)
btn2.grid(row=3,column=1,padx=10,pady=30)
btn3=Button(F2,text='Clear',font='cambria 15 bold',padx=5,pady=10,command=clear,bg='#3B7265',fg='white',width=15)
btn3.grid(row=4,column=0,padx=10,pady=30)
btn4=Button(F2,text='Exit',font='cambria 15 bold',padx=5,pady=10,command=exit,bg='#3B7265',fg='white',width=15)
